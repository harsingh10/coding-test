...
describe("functional -data ", () => {

    // Create a 
    try {
        it("should get the transformed data ", async () => {
            const postData = {
                "payload": {
                    "name": "subscriber",
                    "valueType": "array",
            ...
            const res = await request(app).post("/data").send(postData);

            const expectedRespData = {
                "name": "subscriber",
                "valueType": "array",
                "value": [
                    {
            ...
            expect(JSON.stringify(res.body)).to.equal(JSON.stringify(expectedRespData));
